criaCartao(
    ...
    'utiliza-se a fórmula a seguir: Sn=(a1+ano)x n!')
    
    criaCartao(
    'historia',
    'quem foram os principais líderes das potências dos eixos, na segunda queria mundial?',
    'Adolf Hitler (Alemanha), Benito Mussolini (Itália) e Imperador Hirohito (Japão)')
    
    criaCartao(
    'historia',
    'Qual foi o evento que deu início à Segunda Guerra Mundial?',
    'A invasão da Polônia pela Alemanha em 1º de setembro de 1939.')
    
    criaCartao(
    'historia',
    'O que foi o Holocausto?',
    'O genocídio sistemático, perpetrado pelos nazistas, que resultou na morte de aproximadamente seis milhões de judeus e milhões de outras pessoas.')
